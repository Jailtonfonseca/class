        ...
        carousel: () => {
            ...
            forEach(carousels, function (index, value) {
                ...
                if (value.dataset.carouselOptions != undefined && JSON.parse(value.dataset.carouselOptions).axis === 'vertical') {
                    controlsText = ['<i class="qp-chevron-up"></i>', '<i class="qp-chevron-down"></i>'];
                } else {
                    controlsText = ['<i class="qp-chevron-left"></i>', '<i class="qp-chevron-right"></i>'];
                }
        ...
        gallery: () => {
            ...
            if (gallery.length) {
                for (var i = 0; i < gallery.length; i++) {
                    ...
                    var r = !!gallery[i].dataset.thumbnails, a = !!gallery[i].dataset.video, n = [lgZoom, lgFullscreen],
                        a = a ? [lgVideo] : [], r = r ? [lgThumbnail] : [], r = [].concat(n, a, r);
        ...
        lightbox: () => {
            ...
            if (lightboxToogle.length) {
                for (var i = 0; i < lightboxToogle.length; i++) {
                    var r = !!lightboxToogle[i].dataset.video, a = !!lightboxToogle[i].dataset.zoom, n = !!e[t].dataset.fullscreen, a = a ? [lgZoom] : [],
                        n = n ? [lgFullscreen] : [], r = r ? [lgVideo] : [], r = [].concat(a, n, r);
