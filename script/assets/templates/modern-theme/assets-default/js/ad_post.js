// -------------------------------------------------------------
//  This Is on page Js FOr post and edit ad page
// -------------------------------------------------------------
...
$(document).ready(function() {
    ...
    $("#premium_ad_modal #paymentModalConfirmButton").on('click', function () {
        $('#premium_ad_modal #post_loading').show();
        $('#premium_ad_modal .ModalPayment-figure').hide();
        window.location = payment_uri;
    });
    $("#post_ad_email_exist #link_account").on('click', function () {
...
$('#premium_ad_modal form').on('bind','keypress', function(e) {
    if (e.keyCode == 13) {
        e.preventDefault();
        return false;
    }
});
$('#post_ad_email_exist form').on('bind','keypress', function(e) {
    if (e.keyCode == 13) {
        e.preventDefault();
        return false;
    }
...
function fillPrice(obj, val) {
    if ($(obj).is(':checked')) {
        ...
        //var c = parseFloat(a, 2) + parseFloat(val, 2);
    }
    else {
        var a = $('#totalPrice').text();
        //var c = parseFloat(a, 2) - parseFloat(val, 2);
