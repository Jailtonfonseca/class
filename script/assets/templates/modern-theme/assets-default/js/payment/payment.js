...
<!-- 1. Offline Payment Payment Method Check -->
...
{
    if (paymentMethod == 'wire_transfer' && packagePrice > 0) {
        $('#offlinePayment').show();
    } else {
        $('#offlinePayment').hide();
    }
...
<!-- 2. Paystack Payment Method Check -->
...
<!-- 3. 2Checkout Payment Method Check -->
...
<!-- 6. Payumoney Payment Method Check -->
