...
$(function () {
    ...
    $('#searchStateCity').on('focus',function () {
    ...
    $("#inputStateCity").on('keyup',function () {
    ...
    $("#findCityStateCountry").on('keyup',function () {
        var searchbox = $(this).val();
        var dataString = 'searchword1=' + searchbox;
...
$(document).ready(function () {
    $('#button').on('click',function (e) { // Button which will activate our modal
