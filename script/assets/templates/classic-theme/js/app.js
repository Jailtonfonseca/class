(function ($) {
    $(document).ready(function () {
        ...
        $('#country-popup').on('click', 'ul li .selectme', function (e) {
            ...
            $.cookie('quick_placetext', name, { expires : 1, path: '/' });
            $.cookie('quick_placeid', id, { expires : 1, path: '/' });
            $.cookie('quick_placetype', type, { expires : 1, path: '/' });
        ...
        if (!!$.cookie('quick_placetext')) {
            var placeText = $.cookie("quick_placetext");
            var PlaceId = $.cookie("quick_placeid");
            var PlaceType = $.cookie("quick_placetype");
            if (placeText != null) {
    ...
    $(document).ready(function($) {
        ...
        if (typeof $.cookie('quick_placetext') === 'undefined' && $.cookie('quick_placetext') != ""){
...
function getCityidByCityName(country,state,city) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            // Set cookies
            $.cookie('quick_placetext', city, { expires : 1, path: '/' });
            $.cookie('quick_placeid', response.id, { expires : 1, path: '/' });
            $.cookie('quick_placetype', "city", { expires : 1, path: '/' });
        }
    });
}
