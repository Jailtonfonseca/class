...
<head>
    ...
    <link rel="stylesheet" href="{{ plugin_assets('quickchatajax', 'bootstrap/dist/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ plugin_assets('quickchatajax', 'chatcss/inbox.css') }}">
    <link rel="stylesheet" href="{{ plugin_assets('quickchatajax', 'plugins/smiley/assets/sprites/emojione.sprites.css') }}">
    <link rel="stylesheet" href="{{ plugin_assets('quickchatajax', 'plugins/uploader/jquery.ui.plupload/css/jquery-ui.css') }}">
    <link rel="stylesheet" href="{{ plugin_assets('quickchatajax', 'plugins/uploader/jquery.ui.plupload/css/jquery.ui.plupload.css') }}">
    <link rel="stylesheet" href="{{ plugin_assets('quickchatajax', 'plugins/smiley/js/emojione.min.js') }}">
    <link rel="stylesheet" href="{{ plugin_assets('quickchatajax', 'chatcss/inbox.css') }}">
    <link rel="stylesheet" href="{{ plugin_assets('quickchatajax', 'chatcss/inbox.css') }}">
...
<div id="header">
    <div class="container">
        ...
        <a href="{{ route('dashboard') }}">{{ ___('Dashboard') }}</a>
    </div>
</div>
        ...
        <div class="pane pane-intro" id="pane-intro" style="visibility: visible">
          <div class="intro-body">
            ...
            <div class="intro-text-container" style="opacity: 1; transform: translateY(0px);">
              <h1 class="intro-title">Welcome to chat {{ request()->user()->username }}</h1>
          ...
          <header class="wchat-header">
            ...
            <div class="header-body">
              <div class="header-main">
                <div class="header-title">{{ ___('Profile') }}</div>
              </div>
            </div>
          </header>
                    ...
                    <div id="contact-list">
                            ...
                            <div class="chat-avatar">
                                <div class="avatar icon-user-default" style="height: 40px; width: 40px;">
                                    <div class="avatar-body userimage">
                                        <img class="avatar-image is-loaded" width="100%"
                        ...
                        <div class="form-material">
                            <input class="form-control p-lr-20 live-search-box search_bg" id="searchbox" type="text"
                                   placeholder="{{ ___('Search By Username or Email') }}">
                        </div>
                        ...
                        <div class="menu menu-horizontal">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="white-box text-center bg-purple uploadFile" id="uploadFile">
                                                    <a href="#" class="text-white" data-toggle="tooltip" title=""
                                                       data-original-title="{{ ___('Photos') }}"><i
                                            ...
                                            <div class="col-sm-12">
                                                <div class="white-box text-center bg-success uploadFile"><a href="#"
                                                                                                            ...
                                                                                                            data-toggle="tooltip"
                                                                                                            title=""
                                                                                                            data-original-title="{{ ___('Videos') }}"><i
                                            ...
                                            <div class="col-sm-12">
                                                <div class="white-box text-center bg-info uploadFile"><a href="#"
                                                                                                         ...
                                                                                                         data-toggle="tooltip"
                                                                                                         title=""
                                                                                                         data-original-title="{{ ___('Documents') }}"><i
                            ...
                            <div class="menu-item active dropdown pull-right">
                                ...
                                <ul class="dropdown-menu dropdown-user animated flipInY">
                                    <li><a href="#" onclick="javascript:ShowProfile();">
                                            <i class="ti-user"></i> {{ ___('View Profile') }}
                                        </a>
                                    </li>
                                    <li><a href="{{ route('dashboard') }}">
                                            <i class="ti-wallet"></i> {{ ___('Dashboard') }}
                                        </a>
                                    </li>
                                </ul>
                                <!-- /.dropdown-user -->
...
<script>
    ...
    var CHAT_USERID = @json($userid);
    var CHAT_FULLNAME = @json($chat_fullname);
    var CHAT_USERIMG = @json($chat_userimg);
    var CHAT_USERSTATUS = @json($chat_userstatus);
    ...
    var LANG_NAME = @json(___('Name'));
    var LANG_GENDER = @json(___('Gender'));
    var LANG_ABOUT = @json(___('About'));
...
<script src="{{ plugin_assets('quickchatajax', 'bootstrap/dist/js/bootstrap.min.js') }}"></script>
...
<script src="{{ plugin_assets('quickchatajax', 'chatjs/inbox.js') }}"></script>
<script src="{{ plugin_assets('quickchatajax', 'chatjs/inbox_custom.js') }}"></script>
...
<div id="lightbox" style="display: none;">
    <p><img src="{{ plugin_assets('quickchatajax', 'plugins/images/close-icon-white.png') }}" width="30px" style="cursor: pointer"/></p>
...
<script type="text/javascript">
    ...
    if ($("body").hasClass("rtl")) {
        $('#quickchat-rtl').append('<link rel="stylesheet" type="text/css" href="{{ plugin_assets('quickchatajax', 'chatcss/inbox-rtl.css') }}">');
        var rtl = true;
    }else{
        var rtl = false;
    }
