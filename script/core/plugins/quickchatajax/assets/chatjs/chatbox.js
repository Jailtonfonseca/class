...
var originalTitle;
var audioogg = new Audio(audioogg_path);
var audiomp3 = new Audio(audiomp3_path);
...
emojione.imagePathPNG = emojione_imagePathPNG+'/';
emojione.imagePathSVG = emojione_imagePathSVG+'/';
...
function createChatBox($options) {
    ...
    $("<div />" ).attr("id","chatbox_"+chatid)
        ...
        .html('<div class="chatbox-icon" onclick="javascript:toggleChatBoxGrowth(\''+chatid+'\')" href="#"><div class="contact-floating red"><img class="chat-image img-circle pull-left" src="'+userimage+'"><small class="unread-msg"></small><small class="status"></small></div></div>' +
        '<div class="panel personal-chat"> ' +
        '<div class="panel-heading chatboxhead"> ' +
        '<div class="panel-title">' +
        '<img class="chat-image img-circle pull-left" height="36" width="36" src="'+userimage+'" alt="avatar-image"> ' +
        '<div class="header-elements"><div class="chat_username">'+fullname+'</div>' +
        '<small class="status '+userstatus+'"><b>'+userstatus+'</b></small> ' +
    ...
    get_all_msg(QUICKCHAT_AJAXURL+"?page=1&action=get_all_msg&client="+userid+"&postid="+postid);
    ...
    $("#resultchat_"+chatid).scroll( function(){
        ...
        if ($("#resultchat_"+chatid).scrollTop() == 0){
            ...
            if($("#chatbox_"+chatid+" .pagenum:first").val() != $("#chatbox_"+chatid+" .total-page").val()) {
                ...
                var URL = QUICKCHAT_AJAXURL+"?page="+pagenum+"&action=get_all_msg&client="+userid+"&postid="+postid;
                get_all_msg(URL);
...
function chatHeartbeat(){
    ...
    $.ajax({
        ...
        url: QUICKCHAT_AJAXURL+"?action=chatheartbeat",
        cache: false,
        dataType: "json",
        type: "POST",
        data: {
        ...
        success: function (result) {
            ...
            $.each(result.data, function(i,item){
                ...
                tpl += '<div class="zechat-contact-wrap start_zechat" id="contact_'+item.chatid+'" ' +
                    ...
                    '<div class="zechat-pic" style="background-image: url('+item.userimage+')";></div>' +
                    unread_count +
            ...
            if ($(".zechat-contacts").length == 0) {
                $("<div />").addClass("zechat-contacts zechat-hide-under-768px")
                    .html('<i class="fa fa-bars"></i>' +
                        '<h2>' + LANG_CHATS + ' <a href="'+siteurl+'/message"><i class="icon-feather-message-square"></i></a></h2>' +
...
$(document).on('click', ".uploadFile", function (e){
    ...
    $(function() {
        ...
        $('#uploader_'+chatid).plupload({
            ...
            url: QUICKCHAT_AJAXURL+"?action=uploadFile&to_id="+to_id+"&chatid="+chatid+"&post_id="+postid,
            ...
            filters : {
                ...
                mime_types: [
                    ...
                    {title : "Zip files", extensions : "mp3,mp4,zip"}
                ]
            },
            ...
            plupload.each(arg, function(value, key) {
                if (typeof(value) != "function") {
                    if(key == "response"){
                        ...
                        var jsonStatus = json_var.status;
                        ...
                        if(jsonStatus == "success"){
                            ...
                            var error_message = json_var.message;
                            message_content = "<span class=\"ui-icon ui-icon-alert\"></span>Error: "+error_message;
                            msg_oddtpl(chatid,message_content,'text',LANG_JUST_NOW,"append",0);
                        }
