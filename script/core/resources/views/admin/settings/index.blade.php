        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="nav nav-align-left nav-pills flex-column gap-1" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#quick_theme_setting"><i class="fas fa-paint-brush me-2"></i> {{ ___('Theme Settings') }}</button>
                            </li>
                            <li class="nav-item" role="presentation">
                            ...
                            <li class="nav-item" role="presentation">
                                <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#quick_post_setting"><i class="fas fa-layer-group me-2"></i> {{ ___('Post Settings') }}</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#quick_international"><i class="fas fa-coin-front me-2"></i> {{ ___('International') }}</button>
                            </li>
                            <li class="nav-item" role="presentation">
                            ...
                            <li class="nav-item" role="presentation">
                                <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#quick_map"><i class="fas fa-map-location me-2"></i> {{ ___('Map Settings') }}</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#quick_live_location"><i class="fas fa-location-crosshairs me-2"></i> {{ ___('Live Location') }}</button>
                            </li>
                            <li class="nav-item" role="presentation">
            ...
            <div class="col-md-9">
                <div class="tab-content p-0">
                    ...
                    @include('admin.settings.theme_setting')
                    @include('admin.settings.logo')
                    @include('admin.settings.post_setting')
                    @include('admin.settings.international')
