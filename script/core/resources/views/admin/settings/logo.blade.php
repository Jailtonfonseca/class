        ...
        <div class="quick-card card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <label class="form-label">{{ ___('Home Banner Image') }}</label>
                            <div class="mb-3">
                                <div class="quick-img-card bg-light">
                                    <img id="home_banner_image"
                                         src="{{ asset('storage/banner/'.@$settings->banner_image) }}"
                                         width="100%">
                                </div>
                            </div>
                            <label for="banner_image" class="btn btn-primary w-100 mb-2" tabindex="0">
                                <i class="fas fa-upload me-2"></i>
                                {{ ___('Upload New Image') }}
                                <input name="banner_image" type="file" id="banner_image" hidden
                                       onchange="readURL(this,'home_banner_image')"
