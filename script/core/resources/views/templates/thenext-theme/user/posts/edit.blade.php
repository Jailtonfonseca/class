                ...
                <div class="tg-thememodalcontent">
                    ...
                    <div id="tg-dbcategoriesslider" class="tg-dbcategoriesslider tg-categories owl-carousel select-category post-option">
                        @foreach(categories() as $cat)
                            <div class="tg-category @if($post->category_id == $cat->id) selected @endif" data-ajax-catid="{{ $cat->id }}" data-ajax-action="{{ route('posts.getsubcatbyidList') }}" data-cat-name="{{ $cat->get_translated_title() }}">
                            ...
                            <div class="content with-padding padding-bottom-10">
                                <div class="row">
                                    <div class="col-xl-12">
                                        ...
                                        <div class="form-group selected-product" id="change-category-btn" @if($post->sub_category_id == "") style='display: none' @endif>
